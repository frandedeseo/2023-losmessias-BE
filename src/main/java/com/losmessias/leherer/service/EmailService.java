...
public class EmailService {
    ...
    public void sendWithHTML(String to, String subject, String body) {
        try {
    ...
    public void sendEmailWithLink(String name, String link, String title, String text, String receiverAddress){
        String email = buildEmailWithLink(name, link, title, text);
        sendWithHTML(receiverAddress,title, email);
    }
    public void sendEmail(String name, String title, String text, String receiverAddress){
        String email = buildEmail(name, title, text);
        sendWithHTML(receiverAddress,title, email);
    }

    private String buildEmailWithLink(String name, String link, String title, String text) {
