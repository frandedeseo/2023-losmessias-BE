...
//
//        professorSubjects.add(new ProfessorSubject(professor, new Subject("Math"), 40.00));
//        professorSubjects.add(new ProfessorSubject(professor, new Subject("History"), 40.00));
//
